...
class ConfirmationReviewScreen extends StatefulWidget {
  ...
  @override
  State<ConfirmationReviewScreen> createState() =>
      _ConfirmationReviewScreenState();
}
...
class _ConfirmationReviewScreenState extends State<ConfirmationReviewScreen> {
  ...
  final List<Map<String, dynamic>> mockReviews = [
    {
      'name': 'Ahmad (Gold)',
      'rating': 5.0,
      'review': 'Fantastic service and excellent food package!',
    },
    {
      'name': 'Siti (Silver)',
      'rating': 4.0,
      'review': 'The decoration was amazing, minor delay in serving.',
    },
    {
      'name': 'Raju (Platinum)',
      'rating': 3.5,
      'review': 'Good value for money, but the main course was cold.',
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final BookingData? booking =
        ModalRoute.of(context)!.settings.arguments as BookingData?;

    // Safety Check
    if (booking == null) {
      return const Scaffold(
        body: Center(child: Text("Error: No Booking Data Found")),
      );
    }
    ...
    // Sum the prices of all selected packages
    for (var package in booking.selectedPackages) {
      calculatedTotal += package.pricePerGuest * guestCount;
    }

    // Add extra cost if side menu was selected
    if (booking.hasAdditionalMenu) {
      calculatedTotal += (guestCount * 15.0); // RM15/pax
    }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryRow(
                      'Reserved For:',
                      '${booking.name} ($guestCount Guests)',
                    ),
                    _buildSummaryRow(
                      'Date & Time:',
                    ...
                    _buildSummaryRow(
                      'Packages:',
                      booking.selectedPackages.isNotEmpty
                    ...
                    _buildSummaryRow(
                      'Add-Ons:',
                      booking.hasAdditionalMenu
                          ? "Premium Sides (Included)"
                          : "None",
                    ),
            ...
            const Text(
              'Help us improve by leaving a rating and review.',
